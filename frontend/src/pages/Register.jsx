  ...
  return (
    <div className="min-h-screen flex -mt-20">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center p-12"
        ...
        <div className="absolute -top-[20%] -left-[10%] w-[60%] h-[60%] rounded-full blur-[130px]"
             style={{ background: "rgba(37,99,235,0.1)" }} />
        <div className="absolute -bottom-[20%] -right-[10%] w-[70%] h-[70%] rounded-full blur-[130px]"
        ...
        <div className="relative z-10 max-w-lg">
          <div className="mb-10 flex items-center gap-3">
            ...
            <span className="text-2xl font-bold text-white tracking-tight">SkillNova</span>
          </div>
